...
Open a focused change with tests and update `README.md`, `PLAN.md`, and
`CHANGELOG.md` when behavior changes. Commit messages use an imperative
`type: summary` form such as `fix: preserve published site after failure`.
